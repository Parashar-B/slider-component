...
export default function Slider(){
    const imgList = ['1.webp', '2.webp', '3.webp', '4.jpg', '5.jpg', '6.jpg']
    ...
    return(
        <div className="w-[1500px] h-[680px] bg-white px-[2rem] pt-[2rem] drop-shadow-lg">
            <div className=" h-[85%] outline outline-1 outline-gray-200">
                <img
            ...
            <div className="h-[15%] ">
               ...
               <div className="h-[70%]  flex items-center justify-center">
                    <div className="w-[150px] h-full flex justify-around items-center ">
                        <button className="bg-gray-200 w-[50px] h-[72%] rounded-full text-[1.5rem] font-bold flex items-center justify-center cursor-pointer" 
